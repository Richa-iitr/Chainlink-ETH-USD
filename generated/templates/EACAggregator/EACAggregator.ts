...
export class EACAggregator__getBillingResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class EACAggregator__latestConfigDetailsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Bytes;
...
export class EACAggregator__latestTransmissionDetailsResult {
  value0: Bytes;
  value1: BigInt;
  value2: i32;
  value3: BigInt;
...
export class EACAggregator__validatorConfigResult {
  value0: Address;
  value1: BigInt;
...
export class EACAggregator extends ethereum.SmartContract {
  ...
  getBilling(): EACAggregator__getBillingResult {
    let result = super.call(
      "getBilling",
    ...
    return new EACAggregator__getBillingResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getBilling(): ethereum.CallResult<EACAggregator__getBillingResult> {
    let result = super.tryCall(
      "getBilling",
      "getBilling():(uint32,uint32,uint32,uint32,uint32)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new EACAggregator__getBillingResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestConfigDetails(): EACAggregator__latestConfigDetailsResult {
    let result = super.call(
      "latestConfigDetails",
    ...
    return new EACAggregator__latestConfigDetailsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBytes()
    );
  ...
  try_latestConfigDetails(): ethereum.CallResult<
    EACAggregator__latestConfigDetailsResult
  > {
    let result = super.tryCall(
      "latestConfigDetails",
      "latestConfigDetails():(uint32,uint32,bytes16)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EACAggregator__latestConfigDetailsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBytes()
      )
  ...
  latestTransmissionDetails(): EACAggregator__latestTransmissionDetailsResult {
    let result = super.call(
    ...
    return new EACAggregator__latestTransmissionDetailsResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt(),
  ...
  try_latestTransmissionDetails(): ethereum.CallResult<
    EACAggregator__latestTransmissionDetailsResult
  > {
    let result = super.tryCall(
      "latestTransmissionDetails",
      "latestTransmissionDetails():(bytes16,uint32,uint8,int192,uint64)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EACAggregator__latestTransmissionDetailsResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt(),
  ...
  validatorConfig(): EACAggregator__validatorConfigResult {
    let result = super.call(
      "validatorConfig",
    ...
    return new EACAggregator__validatorConfigResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_validatorConfig(): ethereum.CallResult<
    EACAggregator__validatorConfigResult
  > {
    let result = super.tryCall(
      "validatorConfig",
      "validatorConfig():(address,uint32)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EACAggregator__validatorConfigResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
